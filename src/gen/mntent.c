/*
 * This file is from musl (src/misc/mntent.c) and it's under the MIT license
*/
...
FILE
*setmntent(const char *name, const char *mode)
{
...
struct mntent
*getmntent_r(FILE *f, struct mntent *mnt, char *linebuf, int buflen)
{
...
int
addmntent(FILE *f, const struct mntent *mnt)
{
